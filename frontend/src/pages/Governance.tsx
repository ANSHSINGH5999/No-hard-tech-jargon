...
export default function Governance() {
  ...
  const isLiquidityMiningProposal = paramKey === 'liquidity_mining_program';
      ...
      {showCreateForm && (
        <div className="glass rounded-2xl p-6 space-y-4 border border-yellow-400/15">
          ...
          <div>
            ...
            {isLiquidityMiningProposal ? (
              <textarea
                value={newValue}
                onChange={(e) => setNewValue(e.target.value)}
                placeholder='{"programId":"ecosystem-bootstrap","title":"sXLM/XLM Ecosystem Bootstrap","status":"active","rewardAsset":"sXLM","rewardPerDayRaw":"250000000","startAt":"2026-04-01T00:00:00.000Z","endAt":"2026-06-30T00:00:00.000Z","minLpTokensRaw":"0","dexes":["StellarX","Lumenswap"]}'
                rows={6}
          ...
          <p className="text-xs text-gray-500">
            Minimum 100 sXLM balance required to create a proposal.
            {isLiquidityMiningProposal ? ' Liquidity mining proposals use a JSON payload so rewards can be scheduled on execution.' : ''}
          </p>
          <button
