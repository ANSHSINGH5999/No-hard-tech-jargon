...
| **sdk** | Public TypeScript helpers for DEX quote/routing integrations. |
...
- A 15-minute `sXLM/XLM` TWAP oracle sourced from LP pool reserve observations
- Public DEX endpoints for quotes, direct routing, and market metadata
- Governance-installable liquidity mining programs for StellarX and Lumenswap
- A standalone TypeScript SDK under [`/Users/ansh/Downloads/stello_finance-main/sdk`](/Users/ansh/Downloads/stello_finance-main/sdk)

Integration details and governance payload examples are documented in [`/Users/ansh/Downloads/stello_finance-main/docs/dex-integrations.md`](/Users/ansh/Downloads/stello_finance-main/docs/dex-integrations.md).
